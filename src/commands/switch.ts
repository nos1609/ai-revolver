...
export async function switchProfile(
  ...
  // sync() acquires its own lock on the outgoing profile, so no lock held here yet.
  if (!opts.force) {
  ...
  // Hold lock on the incoming profile for the actual credential write + registry update.
